...
class HostsGenerator
  ...
  def build_header(generated_at: Time.now)
    timestamp = generated_at.strftime('%A, %B %d, %Y at %I:%M:%S %p %Z')
    <<~HEADER
      # DO NOT EDIT THIS FILE
      # This file is automatically generated from nginx-proxy-manager
      # Any changes will be lost
      # Generated: #{timestamp}
      # Generator version: #{AutogenerateHosts::VERSION}
      # https://github.com/romkey/pdxhackerspace-hackstack-autogenerate-hosts
    HEADER
  end
